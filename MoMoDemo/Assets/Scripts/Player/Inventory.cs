...
namespace Momo.Player
{
    public class Inventory
    {
        ...
        public void RemoveItemFromInventory(Fruit fruit, int amount = 1)
        {
            if (amount < 1) return;
        ...
        public void RemoveItemFromInventory(Egg egg, int amount = 1)
        {
            if (amount < 1) return;
        ...
        public void RemoveItemFromInventory(BabyMonster babyMonster, int amount = 1)
        {
            if (amount < 1) return;
        ...
        public void RemoveItemFromInventory(GrownMonster grownMonster, int amount = 1)
        {
            if (amount < 1) return;
            if (grownMonster == null) return;
